...
return array(
				...
				array( 	
						'from' => array('option_name' => 'style_option', 'field_name' => 'iscorpsite' ),
						'to'   => array('option_name' => 'dwh_sites', 'field_name' => 'corpsite_flag' ) 
					),
				array( 	
						'from' => array('option_name' => 'style_option', 'field_name' => 'ctaiscalendarcorpsite' ),
						'to'   => array('option_name' => 'dwh_sites', 'field_name' => 'corpsite_flag' ) 
					),
				array( 	
				...
				array( 	
						'from' => array('option_name' => 'general_option', 'field_name' => 'locationiframe' ),
						'to'   => array('option_name' => 'dwh_api_google_map', 'field_name' => 'map_iframe' ) 
					),
				array( 	
				...
				array( 	
						'from' => array('option_name' => 'style_option', 'field_name' => 'mediaquerystyle' ),
						'to'   => array('option_name' => 'dwh_sites', 'field_name' => 'site_mediaquery' ) 
					),
				array( 	
						'from' => array('option_name' => 'general_option', 'field_name' => 'hotelnames' ),
						'to'   => array('option_name' => 'dwh_hotel_branches', 'field_name' => '' ) 
					),
				array( 	
						'from' => array('option_name' => 'general_option', 'field_name' => 'hotelids' ),
						'to'   => array('option_name' => 'dwh_hotel_branches', 'field_name' => '' ) 
					),
				array( 	
