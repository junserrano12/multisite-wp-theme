<?php
if ( !function_exists( 'onetheme_settings_do_page' ) ) {
    function onetheme_settings_do_page( $main_options = array(), $sub_options = array() )
    {
        ...
        echo '      <a class="button-save button dwh-button-save" onclick="form.submit()">Save</a>';
        echo '  </div>';
        echo $DWH_wponetheme_util->render( $filePath, $viewData, false );
        echo '  <div class="theme-option-submit-button-container">';
        // echo '      <a class="button-save button" onclick="form.submit()">Save</a>';
