<?php
if ( !class_exists( 'dwh_content_widget' ) )
{
    class dwh_content_widget extends WP_Widget
    {
        ...
        public function widget( $args, $instance )
        {
            ...
            $content = isset($instance['dwh-content-widget-textarea']) ? $DWH_wponetheme_util->load_shortcode_content( $instance['dwh-content-widget-textarea'] ) : '';
            $front_page_only = isset( $instance['dwh-content-widget-display-page'] ) ? $instance['dwh-content-widget-display-page'] : false;

            if ( is_front_page() && $front_page_only ) {
                echo $content;
            } else if ( !$front_page_only ) {
                echo $content;
            }
