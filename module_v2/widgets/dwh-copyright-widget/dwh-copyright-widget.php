<?php
if ( !class_exists( 'dwh_copyright_widget' ) )
{
    class dwh_copyright_widget extends WP_Widget
    {
        ...
        {
            $content = isset( $instance['site_copyright_text'] ) ? $instance['site_copyright_text'] : null;
