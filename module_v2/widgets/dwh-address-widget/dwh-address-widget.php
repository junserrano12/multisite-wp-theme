<?php
if ( !class_exists( 'dwh_address_widget' ) )
{
    class dwh_address_widget extends WP_Widget
    {
        public function __construct()
        {
            $widgetdir = basename( __DIR__ );
            $config = dwh_get_config( 'config.widget', 'json', array( 'module_v2', 'widgets', $widgetdir, 'config' ) );
        ...
        public function widget( $args, $instance )
        {
            ...
            $layout = isset( $instance['address_text_layout'] ) ? $instance['address_text_layout'] : 'inline';
            dwh_address( $layout );
        }
